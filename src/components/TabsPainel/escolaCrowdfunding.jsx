...
export default function EscolaCrowdfunding() {
    ...
    return (
        details ? detailsKick() :
            <Center>
                <Desktop>
                    <Title size={30} lineHeight={40} active>Escola de Crowdfunding Kickante</Title>
                    <Title marginTop={5} size={20} lineHeight={24} color={'rgba(68, 68, 68, 0.8)'}>Aqui você encontra tudo para virar um expert em crowdfunding!</Title>

                    <Infographic between={true} />

                    {arrFrame.map((box, indice) =>
                        indice === 0 ?
                            <Link href={`?id=${box.id}`} key={box.id}>
                                <Column marginBottom={10} pointer onClick={() => setTimeout(() => getIdUrl(), 50)}>
                                    <ImageFrameG
                                        src={BannerImageG}
                                        marginTop={15}
                                    />
                    ...
                    <Description marginTop={20} color={'rgba(68, 68, 68, 0.8)'}>Caso você tenha dicas, blogs ou vlogs para compartilhar com a gente, entre em contato com a gente através do nosso formulário de contato, com o assunto: Baú de Ideias, eu também quero participar!</Description>
                </Desktop>

                <Mobile>
                    <Column centerOff={true} width={'100%'} paddingLeft={20} paddingRight={20} marginBottom={60}>
                        <Title size={20} lineHeight={29} active>Escola de Crowdfunding Kickante</Title>
                        <Title marginTop={5} size={16} lineHeight={19} color={'rgba(68, 68, 68, 0.8)'}>Aqui você encontra tudo para virar um expert em crowdfunding!</Title>
                    </Column>
