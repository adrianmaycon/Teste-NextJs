...
import {
    Body, ContainerBox, Option, Select, InputText, Button
...
export default function EditarPerfil() {
    const [select, setSelect] = React.useState('contribuidor');
                ...
                <Column width={'100%'}>
                    <Column width={'100%'}>
                        <Row marginBottom={30}>
                            ...
                            <Box width={822} minHeight={100} border={true} borderColor={'#D5D9D7'} paddingLeft={50} >
                                <Row>
                                    <Column flexStart>
                        ...
                        <Row marginBottom={30}>
                            <Box zInidex={1} marginRight={-35} width={68} height={68} center shadow alignItems={'center'} border={true} color={'#CFD4D2'} borderColor={'#CFD4D2'} radius={100} paddingTop={0.1} paddingBottom={0.1} paddingLeft={0.1} paddingRight={0.1}>
                                <Image width={28} height={40} borderRadius={100} src={Locked} alt="" />
                            </Box>
                            <Box width={822} minHeight={100} border={true} center color={'#CFD4D2'} borderColor={'#CFD4D2'} paddingLeft={50} >
                                <Row>
                                    <Title size={20} lineHeight={21}>Nível liberado automaticamente, resolva o anterior e avance.</Title>
                                    <Column flexStart minWidth={150}>
                                        <Title size={36} lineHeight={38} color={'rgba(68, 68, 68, 0.4)'}>TOP 8%</Title>
                                    </Column>
                                </Row>
                            </Box>
                        </Row>
                        ...
                        <Row marginBottom={30}>
                            ...
                            <Box width={822} minHeight={100} border={true} center color={'#CFD4D2'} borderColor={'#CFD4D2'} paddingLeft={50} >
                                <Row>
                                    <Title size={20} lineHeight={21}>Nível liberado automaticamente, resolva o anterior e avance.</Title>
                                    <Column flexStart minWidth={150}>
                                        <Title size={36} lineHeight={38} color={'rgba(68, 68, 68, 0.4)'}>TOP 7%</Title>
                                    </Column>
                                </Row>
                            </Box>
                        </Row>
                        ...
                        <Row marginBottom={30}>
                            ...
                            <Box width={822} minHeight={100} border={true} center color={'#CFD4D2'} borderColor={'#CFD4D2'} paddingLeft={50} >
                                <Row>
                                    <Title size={20} lineHeight={21}>Nível liberado automaticamente, resolva o anterior e avance.</Title>
                                    <Column flexStart minWidth={150}>
                                        <Title size={36} lineHeight={38} color={'rgba(68, 68, 68, 0.4)'}>TOP 6%</Title>
                                    </Column>
                                </Row>
                            </Box>
                        </Row>
                        ...
                        <Row marginBottom={30}>
                            ...
                            <Box width={822} minHeight={100} border={true} center color={'#CFD4D2'} borderColor={'#CFD4D2'} paddingLeft={50} >
                                <Row>
                                    <Title size={20} lineHeight={21}>Nível liberado automaticamente, resolva o anterior e avance.</Title>
                                    <Column flexStart minWidth={150}>
                                        <Title size={36} lineHeight={38} color={'rgba(68, 68, 68, 0.4)'}>TOP 5%</Title>
                                    </Column>
                                </Row>
                            </Box>
                        </Row>
                        ...
                        <Row marginBottom={30}>
                            ...
                            <Box width={822} minHeight={100} border={true} center color={'#CFD4D2'} borderColor={'#CFD4D2'} paddingLeft={50} >
                                <Row>
                                    <Title size={20} lineHeight={21}>Nível liberado automaticamente, resolva o anterior e avance.</Title>
                                    <Column flexStart minWidth={150}>
                                        <Title size={36} lineHeight={38} color={'rgba(68, 68, 68, 0.4)'}>TOP 4%</Title>
                                    </Column>
                                </Row>
                            </Box>
                        </Row>
                        ...
                        <Row marginBottom={30} flexStart>
                            ...
                            <Box width={822} minHeight={100} border={true} center borderColor={'#05C471'} paddingLeft={70} >
                                <Row>
