...
import { Modal, ModalContainer, TextContainer, Title, Description, Button, Row, Divider } from './styled';

export default function ModalTermsUse(props) {
        ...
        <Modal open={open} >
            <ModalContainer>
                ...
                <TextContainer paddingRight={30} paddingLeft={30}>
                    ...
                    <Description>
                        &nbsp;&nbsp;&nbsp;
                        <b>Atualização:</b> 09 de Novembro de 2018.
                    </Description>

                </TextContainer>

                <Button marginTop={20} color={'#FF8E40'} borderColor={'#FF8E40'} colorHover={'#c77032'} onClick={props.close}>
                    <Description size={14} lineHeight={19} color={'#fff'} marginBottom={1}>
                        FECHAR
                    </Description>
                </Button>
            </ModalContainer>
